...
```bash
# 스프린트 리포트
python3 .claude/skills/javis-report/scripts/report.py sprint

# 특정 스프린트
python3 .claude/skills/javis-report/scripts/report.py sprint "Sprint 13"

# 주간 리포트
python3 .claude/skills/javis-report/scripts/report.py weekly

# Epic 리포트
python3 .claude/skills/javis-report/scripts/report.py epic EUV-3299

# Velocity 리포트
python3 .claude/skills/javis-report/scripts/report.py velocity
```
