---
name: javis-review-plc
description: CODESYS ST 코드 리뷰. Bitbucket PR의 PLC 코드를 Infrastructure 아키텍처, 네이밍 규칙, 시퀀스 데드락, 모듈화 관점으로 분석. 사용법: /javis-review-plc <PR_URL>
argument-hint: "<bitbucket_pr_url> [--no-post] [--no-save]"
allowed-tools: Bash(python3 *), Read, Grep, WebFetch
---

# /javis-review-plc - CODESYS ST PLC 코드 리뷰
...
- 사용 예시: [../javis-review-pr/examples.md](../javis-review-pr/examples.md)
- API 헬퍼 스크립트: [../javis-review-pr/scripts/review_pr.py](../javis-review-pr/scripts/review_pr.py)
