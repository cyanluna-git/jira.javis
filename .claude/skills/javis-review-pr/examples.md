...
```bash
/javis-review-pr https://bitbucket.org/ac-avi/device_gateway/pull-requests/3
```
...
```bash
/javis-review-pr https://bitbucket.org/ac-avi/device_gateway/pull-requests/3 --no-post
```
...
```bash
/javis-review-pr https://bitbucket.org/ac-avi/device_gateway/pull-requests/3 --no-save
```
...
```bash
/javis-review-pr https://bitbucket.org/ac-avi/device_gateway/pull-requests/3 --no-post --no-save
```
...
```bash
# PR 데이터 가져오기
python3 .claude/skills/javis-review-pr/scripts/review_pr.py fetch https://bitbucket.org/ac-avi/device_gateway/pull-requests/3

# 코멘트 게시
cat review.md | python3 .claude/skills/javis-review-pr/scripts/review_pr.py comment https://bitbucket.org/ac-avi/device_gateway/pull-requests/3

# 파일명 정보
python3 .claude/skills/javis-review-pr/scripts/review_pr.py save https://bitbucket.org/ac-avi/device_gateway/pull-requests/3
```
