---
name: review-backend
description: Backend 코드 리뷰. Bitbucket PR의 백엔드 코드를 API 설계, DB, 보안, 동시성, 에러 처리 관점으로 분석. 사용법: /review-backend <PR_URL>
...
Bitbucket PR URL을 입력받아 백엔드 코드를 도메인 전문 관점으로 분석하고, 구조화된 리뷰 코멘트를 PR에 자동으로 게시합니다.
